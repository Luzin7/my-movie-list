export const MOVIES = [
  ...
  },
  {
    ...
    long__description: "Não tem muito o que dizer. O filme é muito bom.",
    rating: "4",
  ...
  },
  {
    ...
    long__description:
      "Como eu passei mais tempo vendo outras coisas do que o próprio filme de tão chato que ele fica, vou deixar a sinopse dele: Woody, Buzz Lightyear e o resto da turma embarcam em uma viagem com Bonnie e um novo brinquedo chamado Forky. A aventura logo se transforma em uma reunião inesperada quando o ligeiro desvio que Woody faz o leva ao seu amigo há muito perdido, Bo Peep.",
    rating: "3",
...
export const NEXT_MOVIES = [
  ...
  },
  {
    ...
    name: "Barbie",
    media:
      "https://assets-prd.ignimgs.com/2022/04/26/barbie-first-look-blogroll-1651016633451.jpg",
  },
  {
    id: 7,
    name: "Invasão Zumbi",
    media: "https://br.web.img3.acsta.net/pictures/16/10/06/23/09/515438.jpg",
  },
  {
    id: 9,
  ...
  },
  {
    ...
    media:
      "https://s2.glbimg.com/F7g7SBpqhxFNHnhDvP1gnv5WJb8=/984x0/smart/filters:strip_icc()/i.s3.glbimg.com/v1/AUTH_63b422c2caee4269b8b34177e8876b93/internal_photos/bs/2019/8/E/BBThprRSeEKcf3GBQf0Q/foto10cul-301-dvd3-d30.jpg",
  },
  {
    id: 13,
    name: "Extermínio (28 Days Later)",
    media: "https://upload.wikimedia.org/wikipedia/pt/e/e4/28_days_later.jpg",
  },
];
